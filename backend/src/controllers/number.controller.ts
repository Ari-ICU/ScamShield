...
function getDetectUrl(req: Request): string {
  const providedIp = req.query.ip as string | undefined;
...
export async function downloadMacroDroid(req: Request, res: Response) {
...
export async function downloadTasker(req: Request, res: Response) {
  const detectUrl = getDetectUrl(req);
